...
//   const colorSchemes = [
//     { from: "from-blue-100", to: "to-purple-100", border: "border-purple-200" },
//     { from: "from-emerald-100", to: "to-teal-100", border: "border-teal-200" },
//     { from: "from-amber-100", to: "to-orange-100", border: "border-orange-200" },
//     { from: "from-rose-100", to: "to-pink-100", border: "border-pink-200" },
//     { from: "from-indigo-100", to: "to-sky-100", border: "border-sky-200" },
//   ];
...
//   return (
//     <motion.div 
//       className={`bg-white rounded-xl shadow-lg overflow-hidden relative flex flex-col h-[450px] w-64 border-2 ${colorScheme.border}`} // Fixed height here
//       onClick={onClick}
...
//       <div className={`absolute inset-0 bg-gradient-to-br ${colorScheme.from} ${colorScheme.to} z-0`} />
...
//             style={{
//               background: `radial-gradient(circle at 50% 50%, ${colorScheme.from.replace('from-', '')} 0%, transparent 70%)`
//             }}
//           />
//         )}
//       </AnimatePresence>
...
//       <div className="relative h-48 flex-shrink-0 p-4 flex items-center justify-center bg-gradient-to-b from-white/70 to-white/30">
//         <motion.div
//           className="h-full flex items-center justify-center"
//           whileHover={{ scale: 1.08, rotate: isHovered ? 2 : 0 }}
...
//               transition={{ duration: 0.4 }}
//               style={{
//                 boxShadow: isHovered ? '0px 10px 20px rgba(0, 0, 0, 0.2)' : '0px 4px 10px rgba(0, 0, 0, 0.1)'
//               }}
//             />
//           ) : (
//             <div className="h-40 w-32 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center shadow-md">
...
//       <div className="p-5 flex flex-col h-[calc(520px-12rem)] relative z-10"> {/* Adjusted height calculation */}
...
//           >
//             <p className="text-xs text-gray-600 line-clamp-3 h-[3.6rem] bg-white/50 p-2 rounded-md">
//               {volumeInfo.description || 'No description available for this book. Check out the details to learn more about this title and its content.'}
//             </p>
//           </motion.div>
//         </div>
...
//           <motion.button
//             className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-2 px-4 rounded-full shadow-sm text-sm font-medium flex items-center gap-2"
//             whileHover={{ 
//               scale: 1.05, 
