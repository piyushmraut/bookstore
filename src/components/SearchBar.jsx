    ...
    <div className="relative max-w-2xl mx-auto">
      ...
      >
        ...
        <input
          ...
          className="w-full pl-12 pr-10 py-3 bg-violet-100 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm border border-violet-800"
        />
        {searchTerm && (
          <button 
            onClick={() => onSearch('')}
